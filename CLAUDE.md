...
| Vol.2 | SNSコンテンツカレンダー | ¥680 | 設計完了・未登録 |
| Vol.3 | 飲食店向けプロンプト集（20本） | ¥1,980 | 制作完了・未登録 |
| Vol.4 | バンドルパック | ¥2,480 | 設計完了・未登録 |

### 📚 完全プレイブック

最初に読むファイル：**`projects/2026-04-08_月30万自動化/PLAYBOOK.md`**
全ての成果物を1枚で俯瞰・ナビゲートできる。

### 🎯 本日の成果物（2026-04-13・15 commits）

準備度100点 — 応募〜請求〜経理まで全工程の資産が揃った状態。

- **応募可能案件：15件分の即コピペ応募文**（CSO/outputs/）
- **プラットフォーム戦略：5サイト同時展開**
- **クライアント返信：8パターンのテンプレ**
- **契約書・請求書・経費管理：CFO事務3点セット**
- **営業リスト：100社分の空テンプレ**
- **サンプル記事：3,200字SEOポートフォリオ**
- **デイリールーティン：朝〜夜の行動スクリプト**
- **ダッシュボード：全4柱・全チャネル進捗管理**
