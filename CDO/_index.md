...
| 2026-06-22 | ops/auto_company/sync_ledger.py | 台帳同期 | 台帳乖離(R5)を自動修復。outputs未記載を追記のみで同期。実行で74件解消(乖離ゼロ) | 完成・実行済 |
| 2026-06-22 | ops/auto_company/apply_cta.py | SELL自動化 | 商品URL確定時に全127記事へCTAを冪等一括挿入。dry-run検証済(127本対象) | 完成・URL待ち |
