...
| 2026-04-11 | `autonomous/products/jp-subsidy-mcp/` | **第1号収益商品** | x402 対応の日本補助金検索 MCP サーバー。Cloudflare Workers 無料枠で動く、USDC 自動決済、14件の seed データ収録、`/search`/`/recommend`/`/detail`/`/mcp` エンドポイント。deploy 待ち | **実装完了・11分デプロイ待ち** |
