...
JP_QUERY = [
    ...
    ("衣替え", ["虫干し", "衣替え", "押入れ", "畳んだ 衣類", "kimono airing"]),
    ...
    ("きのこ", ["えのきたけ 栽培", "ぶなしめじ", "エリンギ", "まいたけ", "enoki mushroom"]),
    ("えのき", ["えのきたけ 栽培", "ぶなしめじ"]),
    ("しめじ", ["ぶなしめじ", "しめじ"]),
    # 朝霧＝**川や田んぼに低く溜まった霧**。山の雲海（上から見下ろす構図）は別物で、
    #   記事は窓から見た低い霧の話。「雲海」は入れない。
    ("朝霧", ["morning fog river", "川霧", "朝霧 田んぼ", "radiation fog", "霧 朝"]),
    ("霧", ["川霧", "morning fog river", "霧 朝"]),
