...
JP_QUERY = [
    ...
    ("早期退職", ["office desk", "デスク", "オフィス"]),
    ("高校野球", ["野球場", "baseball stadium", "野球 グラウンド"]),
    ("夏休みの宿題", ["ノート 鉛筆", "鉛筆", "notebook pencil"]),
    ("昼寝", ["畳", "tatami", "座布団"]),
    ("草むしり", ["雑草", "草取り", "weeding"]),
    ("日焼け", ["麦わら帽子", "straw hat", "日傘"]),
    ("寝苦しい夜", ["扇風機", "electric fan", "枕"]),
    ("行水", ["たらい", "washtub", "盥"]),
    ("水鉄砲", ["水鉄砲", "water gun toy", "水遊び"]),
    ("汗", ["うちわ", "扇子", "uchiwa"]),
    ("怪談", ["提灯", "蚊帳", "paper lantern"]),
    ("夕涼み", ["縁側", "engawa", "夕涼み"]),
    ("夏バテ", ["麦茶", "冷たい麦茶", "barley tea"]),
