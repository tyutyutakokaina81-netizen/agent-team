...
JP_QUERY = [
    ...
    ("衣替え", ["押入れ", "収納 衣類", "kimono storage box", "たとう紙", "虫干し"]),
    ...
    ("用水路", ["用水路", "irrigation canal", "農業用水路", "水路"]),
    ("速い水が流れている", ["疏水", "用水路 日本"]),
    ...
    ("朝霧", ["morning fog rice field", "fog over paddy field", "river mist japan",
             "朝霧 田んぼ", "radiation fog morning"]),
    ...
    ("獅子舞", ["獅子頭", "shishigashira", "獅子舞", "lion dance japan"]),
    ("秋祭り", ["獅子頭", "神輿", "祭り 提灯"]),
