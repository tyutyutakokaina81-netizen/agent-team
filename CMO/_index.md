...
| 2026-05-07 | outputs/_publish_ready/ (gitignore対象) | 30秒公開キット | note 集客記事3本のスタンドアロン .txt（ローカル限定／DATA_POLICY準拠／`node CDO/outputs/quick_publish_kit_generator.mjs` で再生成） | ローカル限定 |
