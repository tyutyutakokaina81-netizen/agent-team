...
echo ""
echo "  【自動化済み（人不要）】"
echo "  ✅ Excelテンプレート生成: $DIST_DIR/"
echo "  ✅ D柱パイプライン: 毎日 09:00・18:00 自動実行"
echo "  ✅ 日次レポート: 毎朝 08:00 自動生成 → $REPORT_LOGFILE"
echo ""
echo "  【あなたが1回だけやること】"
echo "  1. BOOTH アカウント登録・出品ページ設定（下書きは自動作成済み）"
echo "     → https://manage.booth.pm/items"
echo "  2. ランサーズ プロフィール登録"
echo "     → https://www.lancers.jp/profile/edit"
echo "  3. D柱 初回ログイン（1回だけ）"
echo "     → cd $PIPELINE_DIR && python3 00_session_setup.py"
echo "  4. BOOTH 振込先口座登録（売上を受け取るため）"
echo "     → https://manage.booth.pm/payment_accounts"
echo ""
echo "  【毎日やること（30秒）】"
echo "  - 案件応募: パイプラインが開いたブラウザで「応募」ボタンを押すだけ"
echo "  - 売上確認: ログ $REPORT_LOGFILE を確認"
echo ""
