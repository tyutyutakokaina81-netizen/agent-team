...
KEY_MAP = [
    ...
    ("筋子", "ikura-thread"), ("イクラ", "ikura-thread"), ("買ってきて漬ける", "ikura-thread"),
    ("金木犀", "kinmokusei-thread"), ("キンモクセイ", "kinmokusei-thread"), ("角を曲がってくる", "kinmokusei-thread"),
    ...
    ("新蕎麦", "shinsoba-thread"), ("幟が立つ", "shinsoba-thread"),
    ("里芋", "satoimo-thread"), ("さといも", "satoimo-thread"), ("親芋", "satoimo-thread"),
    ("用水路", "water-channels-thread"), ("速い水が流れている", "water-channels-thread"),
