...
| R2b | サムネが実際に使われるか | code | 直近記事のjpgが `_verified.txt` 掲載済か | 新記事ごと | ✅ | — |
| R2c | 無サムネ確定の順守 | code | `_no_auto` の記事に jpg が存在しないこと | 常時 | ✅ | — |
| R2d | フォールバック汚染 | code | 同一画像を3記事以上で共有していないこと(被覆の水増し検知) | 常時 | ⚠️ 44本 | 再取得の要否を判断 |
